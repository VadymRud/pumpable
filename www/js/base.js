...
$(document).on( "pageshow", "#page_statistic", function() {
    ...
    //progress bar begin
    $('<input>').appendTo('.hor_chart_accuracy').attr({'name':'slider','id':'slider','data-highlight':'true','min':'0','max':'100','value':'50','type':'range'}).slider({
    ...
    var chart = new Chartist.Pie('.buble_chart_bounty', {
        ...
        plugins: [
            Chartist.plugins.fillDonut({
                items: [ {
                    content: '<h3 class="donut_text_center">80%</h3>'
                }]
            })
        ]
    });
...
// For the sake of the example we update the chart every time it's created with a delay of 8 seconds
    ...
    var chart = new Chartist.Pie('.buble_chart_accuracy', {
        ...
        plugins: [
            Chartist.plugins.fillDonut({
                items: [ {
                    content: '<h3 class="donut_text_center">20%</h3>'
                }]
            })
        ]
    });
